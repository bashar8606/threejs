...
loader.load(
  ...
  function (gltf) {
    ...
    drone.traverse((o) => {
      if (o.isMesh) {
        // o.material = new THREE.MeshBasicMaterial({map: textureLoader.load(`/3d/super/textures/IOS_Superman_Mat_baseColor.png`)});
        // o.material1 = new THREE.MeshBasicMaterial({map: textureLoader.load(`/3d/super/textures/IOS_Superman_Mat_metallicRoughness.png`)});
      }
    });
    drone.scale.set(0.15, 0.15, 0.15);
    drone.position.set(0, 9, -40);
    // drone.position.x = 0;
    // drone.position.y = 3;
    // drone.position.z = -10;
    ...
    gui.add(gltf.scene.rotation, "x").min(-100).max(100).step(0.01);
    gui.add(gltf.scene.rotation, "y").min(-100).max(100).step(0.01);
    gui.add(gltf.scene.rotation, "z").min(-100).max(100).step(0.01);
...
lightFolder1.add(pointLight.position, "x").min(-100).max(100).step(0.01);
lightFolder1.add(pointLight.position, "y").min(-100).max(100).step(0.01);
lightFolder1.add(pointLight.position, "z").min(-100).max(100).step(0.01);
lightFolder1.add(pointLight, "intensity").min(-100).max(100).step(0.01);
...
cameraPosition.add(camera.position, "x").min(-100).max(100).step(0.01);
cameraPosition.add(camera.position, "y").min(-100).max(100).step(0.01);
cameraPosition.add(camera.position, "z").min(-100).max(100).step(0.01);

const cameraRotation = gui.addFolder("camera Rotation");
cameraRotation.add(camera.rotation, "x").min(-100).max(100).step(0.01);
cameraRotation.add(camera.rotation, "y").min(-100).max(100).step(0.01);
